import { Facebook, Twitter, Instagram, Mail, Apple, PlayCircle, Linkedin, Youtube } from 'lucide-react';
    ...
    <div className="mt-8 bg-black pt-9">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            ...
            <div className="mt-[18px] flex gap-4">
              ...
              <a className="hover:scale-110" target="_blank" href="/">
                <Linkedin className="w-9 h-9 text-white" />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <Instagram className="w-9 h-9 text-white" />
              </a>
              <a className="hover:scale-110" target="_blank" href="">
                <Twitter className="w-9 h-9 text-white" />
              </a>
          ...
          <div className="md:w-[316px]">
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-white">+91 93650 77007</a>
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">yukkta@mail.com</a>
            ...
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">Guwahati, Assam, India, 781026</a>
            ...
            <div className="">
              ...
              <ul>
                <li className="mt-[15px]">
                  <a className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="#services">Services</a>
                </li>
                <li className="mt-[15px]">
                  <a className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="#about">About</a>
                </li>
                <li className="mt-[15px]">
                  <a className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="#join">Join Us</a>
                </li>
                <li className="mt-[15px]">
                  <a className="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold" href="#feedback">Contact</a>
                </li>
              </ul>
            </div>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[12px] font-normal text-white md:text-[14px] text-center">
            &copy; {new Date().getFullYear()} Yukkta Healthcare Technologies. All rights reserved.<br />
            Made with dedication for better healthcare 🌟
          </p>
        </div>
      </div>
    </div>
